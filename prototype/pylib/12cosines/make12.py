...
folder = "/home/samir/db3/prototype/pylib/12cosines/"
makestamps(squares, hf_periods, 0, 0, folder)
makestamps(squares,hf_periods, 1, 1/12, folder)
makestamps(squares, hf_periods, 2, 2/12, folder)
makestamps(squares, hf_periods, 3, 3/12, folder)
makestamps(squares, hf_periods, 4, 4/12, folder)
makestamps(squares,hf_periods, 5, 5/12, folder)
makestamps(squares, hf_periods, 6, 6/12, folder)
makestamps(squares, hf_periods, 7, 7/12, folder)
makestamps(squares, hf_periods, 8, 8/12, folder)
makestamps(squares,hf_periods, 9, 9/12, folder)
makestamps(squares, hf_periods, 10, 10/12, folder)
makestamps(squares, hf_periods, 11, 11/12, folder)
makestamps(squares, periods, 20, 0, folder)
makestamps(squares,periods, 21, 1/12, folder)
makestamps(squares, periods, 22, 2/12, folder)
makestamps(squares, periods, 23, 3/12, folder)
makestamps(squares, periods, 24, 4/12, folder)
makestamps(squares,periods, 25, 5/12, folder)
makestamps(squares, periods, 26, 6/12, folder)
makestamps(squares, periods, 27, 7/12, folder)
makestamps(squares, periods, 28, 8/12, folder)
makestamps(squares,periods, 29, 9/12, folder)
makestamps(squares, periods, 30, 10/12, folder)
makestamps(squares, periods, 31, 11/12, folder)
